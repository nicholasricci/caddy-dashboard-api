...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/audit": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by action (see GET /audit/types)",
                        "name": "action",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by resource (see GET /audit/types)",
                        "name": "resource",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Include logs from this time (RFC3339)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Include logs up to this time (RFC3339)",
                        "name": "to",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.AuditTypesResponse"
                        }
                    }
                }
            }
        ...
        "/api/v1/discovery/{id}/domain-profiles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.domainProfileWriteRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.DomainProfile"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/discovery/{id}/register-domain": {
            "post": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Discovery config ID (Caddy proxy group)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.registerDomainRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RegisterDomainResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/discovery/{id}/register-upstream": {
            "post": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.registerUpstreamRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RegisterUpstreamResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/discovery/{id}/upstream-profiles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.upstreamProfileWriteRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.UpstreamProfile"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/domain-profiles/{id}/register": {
            "post": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.registerDomainByProfileRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RegisterDomainProfileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/scheduled-tasks/{id}/logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Include logs started at or after (RFC3339)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Include logs started at or before (RFC3339)",
                        "name": "to",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/upstream-profiles/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Upstream profile ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/upstream-profiles/{id}/register": {
            "post": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.registerUpstreamByProfileRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RegisterUpstreamProfileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "handlers.createAPIKeyRequest": {
            ...
            "properties": {
                ...
                "allowed_domain_profile_ids": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                },
                "allowed_upstream_profile_ids": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "handlers.domainProfileWriteRequest": {
            "type": "object",
            "required": [
                "bindings",
                "name"
            ...
            "properties": {
                "bindings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DomainProfileBinding"
                    }
                },
                "description": {
                    "type": "string"
        ...
        "handlers.registerDomainByProfileRequest": {
            "type": "object",
            "required": [
                "domains"
            ],
        ...
        "handlers.registerDomainRequest": {
            "type": "object",
            "required": [
                "config_id",
                "domains"
        ...
        "handlers.registerUpstreamByProfileRequest": {
            "type": "object",
            "required": [
                "private_ip"
            ],
        ...
        "handlers.registerUpstreamRequest": {
            "type": "object",
            "required": [
                "config_id"
            ],
        ...
        "handlers.upstreamProfileWriteRequest": {
            "type": "object",
            "required": [
                "bindings",
                "name"
            ...
            "properties": {
                "bindings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.UpstreamProfileBinding"
                    }
                },
                "description": {
                    "type": "string"
        ...
        "models.RegisterDomainProfileResponse": {
            "type": "object",
            "properties": {
                "changed": {
                    "type": "boolean"
                ...
                "targets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.RegisterDomainProfileTarget"
                    }
                }
            }
        },
        "models.RegisterDomainProfileTarget": {
            "type": "object",
            "properties": {
                "config_id": {
                    "type": "string"
        ...
        "models.RegisterUpstreamProfileResponse": {
            "type": "object",
            "properties": {
                "changed": {
                    "type": "boolean"
                ...
                "targets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.RegisterUpstreamProfileTarget"
                    }
                },
                "upstream_profile_id": {
                    "type": "string"
        ...
        "models.RegisterUpstreamProfileTarget": {
            "type": "object",
            "properties": {
                "config_id": {
                    "type": "string"
        ...
        "models.RegisterUpstreamResponse": {
            "type": "object",
            "properties": {
                "changed": {
                    "type": "boolean"

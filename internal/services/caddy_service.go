...
func NewCaddyService(caddySvc *caddysvc.Service, snapshots *repository.SnapshotRepository) *CaddyService {
	return &CaddyService{caddySvc: caddySvc, snapshots: snapshots}
}
